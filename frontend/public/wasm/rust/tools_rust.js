...
const PointCloudToolsRustFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr =>
        wasm.__wbg_pointcloudtoolsrust_free(ptr >>> 0, 1)
      );
...
export class PointCloudToolsRust {
  ...
  static voxel_downsample_direct_static(
    ...
    const ret = wasm.pointcloudtoolsrust_voxel_downsample_direct_static(
      input_ptr,
      point_count,
      voxel_size,
      min_x,
  ...
  point_cloud_smooth(points, smoothing_radius, iterations) {
    try {
      ...
      wasm.pointcloudtoolsrust_point_cloud_smooth(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  generate_voxel_centers(points, voxel_size, min_x, min_y, min_z) {
    try {
      ...
      const ptr0 = passArrayF32ToWasm0(points, wasm.__wbindgen_export_0);
      const len0 = WASM_VECTOR_LEN;
      wasm.pointcloudtoolsrust_generate_voxel_centers(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
...
if (Symbol.dispose)
  PointCloudToolsRust.prototype[Symbol.dispose] =
    PointCloudToolsRust.prototype.free;
