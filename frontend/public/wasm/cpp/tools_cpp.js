var ToolsModule = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    function findWasmBinary() {
      return locateFile('tools_cpp.wasm');
    }
    ...
    function assignWasmExports(wasmExports) {
      Module['_voxelDownsampleDirect'] = _voxelDownsampleDirect =
        wasmExports['Z'];
      Module['_malloc'] = _malloc = wasmExports['_'];
      Module['_free'] = _free = wasmExports['$'];
      Module['_voxelDebugDirect'] = _voxelDebugDirect = wasmExports['aa'];
      ...
      ___cxa_get_exception_ptr = wasmExports['la'];
    }
    var wasmImports = {
